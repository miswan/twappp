...
CustomImageView( ), imagePath: bottomMenuList[index].icon, height: 30.h, width: double.maxFinite, color: color(0XFF8D8B95),

SizedBox(height: 8.h), Text(

bottomMenuList[index].title ?? "",

style: theme.textTheme.labelMedium!.copywith( ), color: color (0XFF8D8B95),
...
), width: double.maxFinite, color: Color(OXFF8165EA),

imagePath: bottomMenuList[index].activeIcon, height: 30.h,
