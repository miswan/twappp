...
initialRoute: AppRoutes.trendingPostsInitialPage, onGenerateRoute: (routesetting) => PageRouteBuilder( pageBuilder: (ctx, ani, ani1) => getCurrentPage(context, routeSetting.name!), transitionDuration: Duration(seconds: 0), ),
...
Widget_buildBottomBar (BuildContext context) {
...
return NotificationsPage.builder(context); case AppRoutes.profilePage:
